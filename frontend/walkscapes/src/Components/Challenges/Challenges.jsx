...
const Challenges = ({
    ...
    useEffect(() => {
        // // // setActiveChallenges(challengesData?.filter(challenges => challenges.is_active) || []);
        // var activeChallengesTemp = challengesData?.reduce((result, challenges) => {
        ...
        // 	const activePolygonsTemp = [];
        // 	for (let i = 0; i < challengesData.length; i++) {
        // 		const challenges = challengesData[i];
        // 		if (challenges.is_active) {
        // 			activePolygonsTemp.push(challenges.polygon);
        // 		}
        // 	}
        // 	var result = activePolygonsTemp;
        // 	console.log('polygons: ', result);
